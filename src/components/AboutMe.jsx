...
const AboutMe = () => {
    return (
        <div id='about' className='w-full h-screen md:pl-20'>
            ...
            <div className='max-w-[1040px] m-auto'>
                ...
                <div className='flex flex-col items-center md:flex-row'>
                    <img className='rounded-full w-64 h-64 md:w-72 md:h-72' src="https://img.freepik.com/premium-vector/man-avatar-profile-picture-vector-illustration_268834-538.jpg" alt="me" />
                    <div>
