        ...
        <div id='home'>
            ...
            <div className='w-full h-screen absolute top-0 left-0 bg-white/30'>
                <div className='max-w-[700px] m-auto h-full w-full flex flex-col justify-center lg:items-center sm:items-center items-center'>
                    <h1 className='md:text-5xl text-2xl font-bold text-gray-800'>Hello, my name is Christian.</h1>
                    <h2 className='md:text-3xl text-xl pt-4 text-gray-800'>I'm a Full-Stack developer.</h2>
